...
description: Custom Theme Builder workflow automation skill. Use when a user needs Custom Theme Builder tasks planned, generated, analyzed, or reported with repeatable outputs, templates, and lightweight local scripts.
---
...
```bash
bash scripts/run.sh --task "example task" --outdir ../../tmp/custom-theme-builder
```
